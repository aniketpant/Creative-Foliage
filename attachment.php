...
<div id="main" class="grid_8 alpha">
        ...
        <article <?php post_class(); ?>>
			...
			<div class="alignleft"><?php previous_image_link(false,__('Previous Attachment','foliage')); ?></div><div class="alignright"><?php next_image_link(false,__('Next Attachment','foliage')); ?></div>
			<div class="clear"></div>
